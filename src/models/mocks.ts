...
import { Activity, ActivityType, Asset, Cell, CellInstance, ConstantProperties, FlowPeriodicity, Game, GameInstance, InstancePlayer, Media, Placeable, Player, Properties, Resource, ResourceFlow, Technology, Vector } from './monolyth';

import {assets} from '../models/assets'



export function randomMedia(prefix:string=''): Media {
    return {
...
let rescount = 0;
export function randomAsset(prefix:string): Asset {
